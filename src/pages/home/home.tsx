    ...
    <LayoutAnimation>
      <div className="md:flex md:mt-40">
        <div className="p-8">
          ...
          <div className="mt-10">
            <button className="inline px-5 py-2  cursor-pointer bg-skin-base text-white font-medium rounded-3xl">
              More About Me
            </button>
          </div>
        </div>
        <div className="md:shrink-0 md:pr-28">
          <div className="relative px-6 py-6 items-center justify-center">
            <div className="absolute top-0 right-0 h-20 w-20 border-skin-base border-t-8 border-r-8" />
            <div className="absolute bottom-0 left-0 h-20 w-20 border-skin-base border-b-8 border-l-8" />
